...
Router.register('mercado', function(main) {
      ...
      '<div class="mc-grupo-col">' +
        ...
        '<div class="mc-grupo-cards">' +
          ...
          ctxCard('c6','IPCA Alim.','📊','+0,9%',false,'Acum. 12m: +8,1%',false,'up','▲ Acima da meta',
            ...
            ['priorizar mix de valor percebido alto']) +
        '</div></div>' +
  ...
  '<div class="section-block anim d5 mc-exp-block">' +
    ...
    '<div style="overflow-x:auto"><table class="mc-pvt"><thead><tr><th style="text-align:left">Produto</th><th>Nov/25</th><th>Dez/25</th><th>Jan/26</th><th>Fev/26</th><th>Mar/26</th><th>Abr/26</th><th style="background:rgba(201,168,76,0.22);color:#6A4C00">Média</th></tr></thead><tbody>' +
  ...
  main.querySelectorAll('.mc-hb').forEach(function(hbEl) {
    var ht = hbEl.querySelector('.mc-ht'); if (!ht) return;
  ...
  function buildCotChart(id, data, lc, fc, fmtFn) {
    ...
    var chart = new Chart(cvs, {
      ...
      data: { labels: MESES, datasets: [{
        data: data, borderColor: lc, borderWidth: 2.5, tension: 0.35, fill: true,
  ...
  main.querySelectorAll('.mc-cd.calhov').forEach(function(day) {
    day.addEventListener('mouseenter', function() {
      ...
      tip.style.left=Math.max(8,r.left-60)+'px'; tip.style.top=(r.top+window.scrollY-180)+'px';
